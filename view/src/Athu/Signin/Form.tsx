...
function signIn() {
    ...
    return (
        ...
        <button type= "submit" className='btn_google'>
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24" aria-hidden="true" data-testid="google-icon">
        ...
        11.2969C4.8537 12.2549 4.94472 13.1891 5.21777 14.1088C5.23693 14.1471 5.24172 14.195 5.24651 14.2429Z" fill="#FABB06"></path></svg>
